...
You can use at most one tool. You can use a tool at most once. If you use a tool, the tool's output must be the value of the final answer.

If the question cannot be solved by using a tool, answer the question without using a tool.
